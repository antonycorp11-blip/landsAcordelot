...
NAMED_MAP = {
    ...
    'gov_isolde.png':   ('advisors', 'gov_isolde',   360, 0.5),
    'gov_maerwyn.png':  ('advisors', 'gov_maerwyn',  360, 0.5),
    'gov_aldric.png':   ('advisors', 'gov_aldric',   360, 0.5),
    'gen_cael.png':     ('advisors', 'gen_cael',     360, 0.5),
    'gen_roderic.png':  ('advisors', 'gen_roderic',  360, 0.5),
    'gen_bryn.png':     ('advisors', 'gen_bryn',     360, 0.5),
